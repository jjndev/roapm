...
set_hitbox_value(this_attack, 1, HG_HITBOX_X, 13);
set_hitbox_value(this_attack, 1, HG_HITBOX_Y, -24);
set_hitbox_value(this_attack, 1, HG_WIDTH, 56);
set_hitbox_value(this_attack, 1, HG_HEIGHT, 42);
...
set_hitbox_value(this_attack, 2, HG_HITBOX_Y, -22);
set_hitbox_value(this_attack, 2, HG_WIDTH, 46);
set_hitbox_value(this_attack, 2, HG_HEIGHT, 48);
...
set_hitbox_value(this_attack, 2, HG_SDI_MULTIPLIER, 0.75);
set_hitbox_value(this_attack, 2, HG_HITSTUN_MULTIPLIER, 1.2);
...
set_hitbox_value(this_attack, 3, HG_HITBOX_Y, -22);
set_hitbox_value(this_attack, 3, HG_WIDTH, 46);
set_hitbox_value(this_attack, 3, HG_HEIGHT, 48);
...
set_hitbox_value(this_attack, 3, HG_SDI_MULTIPLIER, 0.75);
set_hitbox_value(this_attack, 3, HG_HITSTUN_MULTIPLIER, 1.2);
/*
set_attack_value(this_attack, AG_SPRITE, sprite_get_pm("jab"));
