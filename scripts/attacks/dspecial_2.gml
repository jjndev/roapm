...
var y_offset = -30;
var diameter_lvl_1 = 124;
var diameter_lvl_2 = 174;
var diameter_lvl_3 = 224;
...
set_hitbox_value(AT_DSPECIAL_2, 1, HG_BASE_KNOCKBACK, 8.5);
...
set_hitbox_value(AT_DSPECIAL_2, 2, HG_BASE_KNOCKBACK, 9.25);
...
set_hitbox_value(AT_DSPECIAL_2, 4, HG_DAMAGE, 13);
set_hitbox_value(AT_DSPECIAL_2, 4, HG_BASE_KNOCKBACK, 10);
set_hitbox_value(AT_DSPECIAL_2, 4, HG_KNOCKBACK_SCALING, .85);
