...
set_window_value(this_attack, 5, AG_WINDOW_ANIM_FRAMES, 4);
...
set_hitbox_value(this_attack, 1, HG_HITBOX_Y, -76);
set_hitbox_value(this_attack, 1, HG_HITBOX_X, 0);
set_hitbox_value(this_attack, 1, HG_WIDTH, 98);
set_hitbox_value(this_attack, 1, HG_HEIGHT, 92);
...
set_hitbox_value(this_attack, 2, HG_WIDTH, 48);
set_hitbox_value(this_attack, 2, HG_HEIGHT, 20);
set_hitbox_value(this_attack, 2, HG_PRIORITY, 3);
set_hitbox_value(this_attack, 2, HG_DAMAGE, 5);
