...
set_hitbox_value(this_attack, 1, HG_HITBOX_X, 12);
...
set_hitbox_value(this_attack, 1, HG_HEIGHT, 44);
...
set_hitbox_value(this_attack, 2, HG_HITBOX_X, 12);
...
set_hitbox_value(this_attack, 2, HG_HEIGHT, 44);
