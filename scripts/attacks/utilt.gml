...
set_hitbox_value(this_attack, 1, HG_HITBOX_X, -3);
set_hitbox_value(this_attack, 1, HG_WIDTH, 78);
set_hitbox_value(this_attack, 1, HG_HEIGHT, 56);
...
set_hitbox_value(this_attack, 2, HG_BASE_HITPAUSE, 8);
